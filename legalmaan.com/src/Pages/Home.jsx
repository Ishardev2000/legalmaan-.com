    ...
    <>
      ...
      <section className=' bg-[#fefafa] py-8'>
        <div className="container mx-auto  flex px-10 py-19 md:flex-row flex-col items-center">
          <div
            ...
            <h1 className="title-font sm:text-4xl text-3xl mb-15 font-bold font-serif text-gray-900 "><b> Hey, I'm Yamman </b>
            </h1>
            <h3 className="mt-12 leading-relaxed title-font sm:text-4xl font-medium text-3xl mb-15  text-gray-900 ">Legally Protect YOU and Your BUSINESS</h3>
            <div className="flex justify-center">
              <button src="contect" type="button" className="text-white bg-black hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium mt-9 rounded-full text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-black dark:hover:bg-gray-600 hover:text-black dark:focus:ring-blue-800">Contact Now</button>
      ...
      <section className='py-25 mt-20'>
        <div className="flex flex-col items-center text-center justify-center h-screen p-20">
          <h1 className="text-4xl font-bold text-gray-800 mb-4 underline-offset-1 decoration-black font-serif">Who I AM?</h1>
      ...
      <section className='py-25 mt-20'>
        ...
        <div className="px-10 py-10">
          ...
          <div id="features" className="mx-auto  max-w-6xl">
            ...
            <h2 className="text-center font-display text-3xl font-bold tracking-tight text-slate-900 font-serif md:text-4xl">
          ...
          <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div className="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
              <div className="flex items-center gap-12">
                <h2 className="text-2xl font-bold  text-gray-800 lg:text-3xl font-serif dark:text-black">My Portfolio</h2>
      ...
      <section className='py-12 mt-10'>
        <div className="container mx-auto px-20">
          <h2 className="text-3xl font-bold text-gray-800 text-center font-serif mb-8">What Our Clients Say</h2>
