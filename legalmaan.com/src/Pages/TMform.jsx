...
function TMform() {
  return (
    <>
      {/* TM form */}
      <section className="">
        <div className="relative bg-gradient-to-r bg-[#fefafa] from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
        ...
        <div className="bg-[#fefafa] rounded-lg  md:p-36 sm:p-5 relative">
          ...
          <div className="p-6 space-y-6 bg-[#fefafa]">
            <form action="#">
            ...
            <div className="mb-6 ">
              ...
              <b>
                <h1 className="flex items-center my-6">
                  Please select the entity type which best explains the owner.
                  If your entity type is not one of the options please select
                  "Other" <br />
